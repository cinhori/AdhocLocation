...
public class StringToLatLong {
    public static Point toLatLong(String llString){
        if (llString.startsWith("05 00 82")){

            int id  = Integer.valueOf(llString.substring(12, 17).replaceAll(" ", ""), 16);
            //System.out.println("id:" + id);

            double longitude = Integer.valueOf(llString.substring(27, 38).replaceAll(" ", ""), 16) * 0.00001;
            //System.out.println("longitude:" + longitude);

            double latitude = Integer.valueOf(llString.substring(39, 50).replaceAll(" ", ""), 16) * 0.00001;
